    ...
    public class ADUserDetail
    {
        ...
        private ADUserDetail(DirectoryEntry directoryUser)
        {
            ...
            if (!string.IsNullOrEmpty(domainAddress))
            {
                ...
                domainName = domainAddress.Split('.')[0];
            }
            else
            {
            ...
            _objectsid = GetProperty2(directoryUser, ADProperties.OBJECTSID);
        ...
        private static String GetProperty2(DirectoryEntry userDetail, String propertyName)
        {
            
                string si = new SecurityIdentifier((byte[])userDetail.Properties[propertyName][0], 0).Value;
                return si;
            /*Otra forma de obtener el Security ID se comenta abajo
             NTAccount account2 = new NTAccount("notitarde.com", obAD.LDAPUser);
             SecurityIdentifier sid = (SecurityIdentifier)account2.Translate(typeof(SecurityIdentifier));
