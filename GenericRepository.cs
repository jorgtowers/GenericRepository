...
{
    /// <summary>
    /// Clase equipada con métodos génericos para interáctuar con Objetos de Entity, se requiere crear una clase GenericRepository:GenericReposity de tipo oEntities
    /// </summary>
    /// <typeparam name="T">ObjetoEntity que provee el acceso al Modelo</typeparam>
    public class GenericRepository<T> where T:ObjectContext, new()
    {    
        public static T model=new T();       
